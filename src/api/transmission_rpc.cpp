...
TransmissionRpcHandler::TransmissionRpcHandler(TorrentManager *torrent_manager,
    ...
    : torrent_manager_(torrent_manager), download_dir_(download_dir) {}
...
HttpResponse TransmissionRpcHandler::handle_request(const HttpRequest &req) {
  try {
    ...
    pixellib::core::json::JSON tag =
        tag_it ? *tag_it : pixellib::core::json::JSON(0.0);
    pixellib::core::json::JSON args =
        args_it ? *args_it : pixellib::core::json::JSON::object({});

    if (!method_it || !method_it->is_string()) {
      return create_response("invalid method",
                             pixellib::core::json::JSON::object({}), tag);
    }
    ...
    return create_response("method not implemented",
                           pixellib::core::json::JSON::object({}), tag);

  } catch (const std::exception &e) {
    return create_response(e.what(), pixellib::core::json::JSON::object({}),
                           pixellib::core::json::JSON(0.0));
  }
}

HttpResponse
TransmissionRpcHandler::torrent_get(const pixellib::core::json::JSON &args,
...
HttpResponse
TransmissionRpcHandler::torrent_add(const pixellib::core::json::JSON &args,
                                    const pixellib::core::json::JSON &tag) {
  ...
  if (metainfo_it && metainfo_it->is_string()) {
    try {
      ...
      auto decode_base64 = [](const std::string &encoded,
                              const std::string &base64_chars) -> std::string {
        std::string decoded;
      ...
      std::string decoded_data =
          decode_base64(metainfo_it->as_string(), base64_chars);
      std::string id = torrent_manager_->add_torrent_data(decoded_data);

      pixellib::core::json::JSON arguments =
          pixellib::core::json::JSON::object({});
      pixellib::core::json::JSON torrent_added =
          pixellib::core::json::JSON::object({});
  ...
  return create_response("missing filename or metainfo",
                         pixellib::core::json::JSON::object({}), tag);
}

HttpResponse
TransmissionRpcHandler::torrent_remove(const pixellib::core::json::JSON &args,
                                       const pixellib::core::json::JSON &tag) {
  ...
  if (ids_it && ids_it->is_array()) {
    ...
    return create_response("success", pixellib::core::json::JSON::object({}),
                           tag);
  }
  return create_response("invalid ids", pixellib::core::json::JSON::object({}),
                         tag);
}

HttpResponse
TransmissionRpcHandler::torrent_start(const pixellib::core::json::JSON &args,
                                      const pixellib::core::json::JSON &tag) {
  auto ids_it = args.find("ids");
  if (ids_it && ids_it->is_array()) {
    for (const auto &id_val : ids_it->as_array()) {
...
HttpResponse
TransmissionRpcHandler::torrent_stop(const pixellib::core::json::JSON &args,
                                     const pixellib::core::json::JSON &tag) {
  auto ids_it = args.find("ids");
  if (ids_it && ids_it->is_array()) {
    for (const auto &id_val : ids_it->as_array()) {
...
HttpResponse
TransmissionRpcHandler::session_get(const pixellib::core::json::JSON &args,
                                    const pixellib::core::json::JSON &tag) {
  (void)args;
  pixellib::core::json::JSON arguments = pixellib::core::json::JSON::object({});
  arguments["version"] = pixellib::core::json::JSON("4.0.0");
  arguments["rpc-version"] = pixellib::core::json::JSON(17.0);
  arguments["download-dir"] = pixellib::core::json::JSON(download_dir_);

  return create_response("success", arguments, tag);
}

HttpResponse TransmissionRpcHandler::create_response(
    const std::string &result, const pixellib::core::json::JSON &arguments,
    const pixellib::core::json::JSON &tag) {
